...
export declare type EventResponse = PushapeRegistrationEventResponse & RegistrationEventResponse & NotificationEventResponse & Error;
...
export declare type PushEvent = 'registration' | 'notification' | 'error';
 ...
 * PushapeOptions
 */
export declare class PushapePushOriginal extends AwesomeCordovaNativePlugin {
    /**
...
export declare const PushapePush: PushapePushOriginal;