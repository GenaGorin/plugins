 ...
 */
export declare enum TokeniseType {
    /**
 ...
 */
export declare enum TokeniseFromat {
    /**
     * none: no format
     */
    none = "1",
 ...
 * TransactionClass
 */
export declare enum TransactionClass {
    /**
 ...
 */
export declare enum AlternativePaymentMethod {
    /**
 ...
 * ```
 */
export declare class PayTabsOriginal extends AwesomeCordovaNativePlugin {
    /**
     * Start Card Payment
     *
...
export declare const PayTabs: PayTabsOriginal;