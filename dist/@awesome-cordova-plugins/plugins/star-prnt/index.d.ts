 ...
 */
export declare type Printers = Array<Printer>;
 ...
 */
export declare type CommandsArray = Array<PrintCommand>;
/**
 * @name StarPRNT
 * @description
 ...
 * ```
 */
export declare class StarPRNTOriginal extends AwesomeCordovaNativePlugin {
    /**
