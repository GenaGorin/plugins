 ...
 * ```
 */
export declare class BluetoothClassicSerialPortOriginal extends AwesomeCordovaNativePlugin {
    /**
...
export declare const BluetoothClassicSerialPort: BluetoothClassicSerialPortOriginal;