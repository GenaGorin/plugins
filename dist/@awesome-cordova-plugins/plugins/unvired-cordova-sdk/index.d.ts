 ...
 */
export declare enum OutboxLockStatus {
    LockApplied = 0,
    DataBeingSent = 1,
    DataNotInQueue = 2
}
...
export declare class OutboxLockResult extends UnviredResult {
    type: ResultType;
...
export declare class UnviredCredential {
    user: string;
    password: string;
    port: string;
}
 ...
 */
export declare class UnviredCordovaSDKOriginal extends AwesomeCordovaNativePlugin {
     ...
     */
    setClientCredentials(credentials: UnviredCredential[]): void;
    /**
