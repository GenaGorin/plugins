 ...
 * ```
 */
export declare class ImapOriginal extends AwesomeCordovaNativePlugin {
    /**
     ...
     */
    listMessagesHeadersByDate(folderName: string, dateInMilliseconds: number, comparison: Comparison): Promise<MessageHeaders[]>;
    /**
...
export declare const Imap: ImapOriginal;