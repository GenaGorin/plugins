 ...
 * ```
 */
export declare class IosASWebauthenticationSessionOriginal extends AwesomeCordovaNativePlugin {
    /**
...
export declare const IosASWebauthenticationSession: IosASWebauthenticationSessionOriginal;